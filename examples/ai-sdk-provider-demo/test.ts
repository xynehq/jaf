...
import { run, createRunId, createTraceId, type RunConfig, ToolResponse, ToolErrorCodes, withErrorHandling, Tool } from '@xynehq/jaf';
...
async function main() {
  ...
  // console.log(openai("gpt-4o").doGenerate()))
...
const calculatorTool: Tool<{ expression: string }, null> = {
  ...
  if (result.outcome.status === 'completed') {
    ...
    console.log('[ai-sdk-provider-demo] Raw result:', JSON.stringify(result, null, 2));
